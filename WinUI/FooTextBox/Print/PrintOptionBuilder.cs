...
namespace FooEditEngine.WinUI
{
    ...
    /// </para>
    /// </summary>
    public sealed class PrintOptionBuilder<T> where T : IFooDocumentSource
    {
        T PrintDocument;
        /// <summary>
        /// コンストラクター
        ...
        {
            ResourceMap map = ResourceManager.Current.MainResourceMap.GetSubtree(FooTextBox.ResourceKey);
